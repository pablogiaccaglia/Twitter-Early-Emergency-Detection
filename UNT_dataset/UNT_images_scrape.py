...
if __name__ == '__main__':
    ...
    UNT_urls_json_dict = "UNT_tweets_media_urls.json"
    ONEDRIVE_FOLDER_ID = "ONEDRIVE_FOLDER_ID"
    AT = "ACCESS_TOKEN"
    data_dict = utils.get_loaded_json_file(path = UNT_urls_json_dict)
    CHUNK_SIZE = 50000

    chunk = sorted(list(data_dict.keys()))[:CHUNK_SIZE]

    # SINGLE CHUNK OF DATA UPLOADED due to ACCESS TOKEN EXPIRATION
