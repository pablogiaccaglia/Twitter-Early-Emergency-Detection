...
if __name__ == '__main__':
    ...
    # split scraping into chunks for stability purposes
    ...
    utils.build_tweets_csv(tweets_ids = Kaggle_tweets_ids, csv_filename = "datasets_csv/Kaggle_dataset.csv")
    ...
    utils.build_tweets_csv(tweets_ids = CrisisMMD_tweets_ids, csv_filename = "datasets_csv/CrisisMMD_dataset.csv")
